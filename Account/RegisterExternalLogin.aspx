<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/MainsiteMaster.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="DatabaseObjectClass.Account.RegisterExternalLogin" %>
<asp:Content ContentPlaceHolderID="ChangeableContent" runat="server">
    <hgroup class="title">
