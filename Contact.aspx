...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="ChangeableContent">
    <div class="mobilereadable">
        ...
        <%-- The below was laid out for better readability (01.19.2015) --%>
        ...
        <section class="contact">
            ...
            <p>
                <span class="label">Support:<a href="mailto:jllblk@hotmail.com">Contact IT Director Joel Black</a>

                </span>
            </p>
            <p>
                <span class="label">Marketing:<a href="mailto:gcollins5839@yahoo.com">Contact Pastor Gary Collins</a>

                </span>
            </p>
            <p>
                <span class="label">General:<a href="mailto:Ken@therockstl.com">Email the Pastor, Ken Robinson</a>
